<?php
/**
 * Imobiliaria_Form_InteresseCliente
 *
 ...
 * @since   1.0
 */
class Imobiliaria_Form_InteresseCliente extends Zend_Form
{
	/**
	...
	{
		$id = new Zend_Form_Element_Hidden('id_interesse');
	...
	*/
	...
	private function _getSubmit()
	{
		...
		$salvar->setLabel('Cadastrar Interesse');
