...
class Application_Model_TelefoneClientes extends Zend_Db_Table
{
	protected $_name = 'telefone_clientes';

	protected $_primary = array('id_telefone', 'id_cliente');

	protected $_cols = array('id_telefone', 'id_cliente');
